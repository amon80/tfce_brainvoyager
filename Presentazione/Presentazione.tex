...
$$TFCE(p)=\int_{h=h_0}^{h_p}e(h)^E h^H dh$$
\begin{itemize}
\item La scelta dei parametri $E$ ed $H$ risulta essere cruciale per avere l'output desiderato.

\item L'obiettivo \'e scegliere tali parametri in modo che si adattino ad un ampio set di segnali e rumore.
...
\begin{itemize}
\item Ci\'o \'e desirabile in quanto vengono favoriti cluster di intensit\'a molto alta rispetto a quelli con intensit\'a piu' bassa.
\end{itemize}
\medskip
